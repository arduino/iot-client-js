...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IotApi.BatchQueryRawResponseSeriesMediaV1();
  });
  ...
  describe('BatchQueryRawResponseSeriesMediaV1', function() {
    it('should create an instance of BatchQueryRawResponseSeriesMediaV1', function() {
      ...
      //var instane = new IotApi.BatchQueryRawResponseSeriesMediaV1();
      //expect(instance).to.be.a(IotApi.BatchQueryRawResponseSeriesMediaV1);
    });
