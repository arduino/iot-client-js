...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ArduinoIotClient.PropertyDefinition();
  });
  ...
  describe('PropertyDefinition', function() {
    it('should create an instance of PropertyDefinition', function() {
      ...
      //var instance = new ArduinoIotClient.PropertyDefinition();
      //expect(instance).to.be.a(ArduinoIotClient.PropertyDefinition);
    });
