...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IotApi.BatchQueryRawRequestsMediaV1();
  });
  ...
  describe('BatchQueryRawRequestsMediaV1', function() {
    it('should create an instance of BatchQueryRawRequestsMediaV1', function() {
      ...
      //var instane = new IotApi.BatchQueryRawRequestsMediaV1();
      //expect(instance).to.be.a(IotApi.BatchQueryRawRequestsMediaV1);
    });
