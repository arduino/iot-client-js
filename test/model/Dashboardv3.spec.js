...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ArduinoIotClient.Dashboardv3();
  });
  ...
  describe('Dashboardv3', function() {
    it('should create an instance of Dashboardv3', function() {
      // uncomment below and update the code to test Dashboardv3
      //var instance = new ArduinoIotClient.Dashboardv3();
      //expect(instance).to.be.a(ArduinoIotClient.Dashboardv3);
    });
