...
(function(root, factory) {
  ...
  describe('ArduinoThingtemplate', function() {
    ...
    it('should have the property deviceMetadata (base name: "device_metadata")', function() {
    ...
    it('should have the property sketchTemplate (base name: "sketch_template")', function() {
      // uncomment below and update the code to test the property sketchTemplate
      //var instance = new ArduinoIotClient.ArduinoThingtemplate();
      //expect(instance).to.be();
    });
