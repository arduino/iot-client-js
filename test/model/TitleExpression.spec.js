...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ArduinoIotClient.TitleExpression();
  });
  ...
  describe('TitleExpression', function() {
    it('should create an instance of TitleExpression', function() {
      // uncomment below and update the code to test TitleExpression
