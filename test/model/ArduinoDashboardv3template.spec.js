...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ArduinoIotClient.ArduinoDashboardv3template();
  });
  ...
  describe('ArduinoDashboardv3template', function() {
    it('should create an instance of ArduinoDashboardv3template', function() {
      // uncomment below and update the code to test ArduinoDashboardv3template
      //var instance = new ArduinoIotClient.ArduinoDashboardv3template();
      //expect(instance).to.be.a(ArduinoIotClient.ArduinoDashboardv3template);
    });
