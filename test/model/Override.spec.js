...
(function(root, factory) {
  ...
  describe('Override', function() {
    ...
    it('should have the property newThingId (base name: "new_thing_id")', function() {
      // uncomment below and update the code to test the property newThingId
      //var instance = new ArduinoIotClient.Override();
      //expect(instance).to.be();
    });

    it('should have the property oldThingId (base name: "old_thing_id")', function() {
      // uncomment below and update the code to test the property oldThingId
      //var instance = new ArduinoIotClient.Override();
      //expect(instance).to.be();
    });
