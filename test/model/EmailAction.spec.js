...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ArduinoIotClient.EmailAction();
  });
  ...
  describe('EmailAction', function() {
    it('should create an instance of EmailAction', function() {
      // uncomment below and update the code to test EmailAction
      //var instance = new ArduinoIotClient.EmailAction();
