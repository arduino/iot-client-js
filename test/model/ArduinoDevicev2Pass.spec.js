...
(function(root, factory) {
  ...
  describe('ArduinoDevicev2Pass', function() {
    it('should create an instance of ArduinoDevicev2Pass', function() {
      ...
      //var instane = new ArduinoIotClient.ArduinoDevicev2Pass();
    ...
    it('should have the property suggestedPassword (base name: "suggested_password")', function() {
      // uncomment below and update the code to test the property suggestedPassword
      //var instane = new ArduinoIotClient.ArduinoDevicev2Pass();
      //expect(instance).to.be();
    });
