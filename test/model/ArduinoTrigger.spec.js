...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ArduinoIotClient.ArduinoTrigger();
  });
  ...
  describe('ArduinoTrigger', function() {
    it('should create an instance of ArduinoTrigger', function() {
      // uncomment below and update the code to test ArduinoTrigger
