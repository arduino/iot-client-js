...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ArduinoIotClient.BodyExpression();
  });
  ...
  describe('BodyExpression', function() {
    it('should create an instance of BodyExpression', function() {
      // uncomment below and update the code to test BodyExpression
      //var instance = new ArduinoIotClient.BodyExpression();
      //expect(instance).to.be.a(ArduinoIotClient.BodyExpression);
    });
