...
* <pre>
* var @ArduinoArduinoIotClient = require('index'); // See note below*.
* var xxxSvc = new @ArduinoArduinoIotClient.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new @ArduinoArduinoIotClient.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new @ArduinoArduinoIotClient.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new @ArduinoArduinoIotClient.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
