...
/**
 * The Widgetv3 model module.
 * @module model/Widgetv3
 * @version 3.1.2
 */
class Widgetv3 {
    /**
     * Constructs a new <code>Widgetv3</code>.
     * Widget describes a dashboard widget
     * @alias module:model/Widgetv3
    ...
    constructor(height, id, options, type, width, x, y) { 
        ...
        Widgetv3.initialize(this, height, id, options, type, width, x, y);
    }
    ...
    /**
     * Constructs a <code>Widgetv3</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Widgetv3} obj Optional instance to populate.
     * @return {module:model/Widgetv3} The populated <code>Widgetv3</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Widgetv3();
    ...
    /**
     * Validates the JSON data with respect to <code>Widgetv3</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Widgetv3</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Widgetv3.RequiredProperties) {
...
Widgetv3.RequiredProperties = ["height", "id", "options", "type", "width", "x", "y"];

/**
 * Widget current height for desktop
 * @member {Number} height
 */
Widgetv3.prototype['height'] = undefined;

/**
 * Widget current height for mobile
 * @member {Number} height_mobile
 */
Widgetv3.prototype['height_mobile'] = undefined;

/**
 * The UUID of the widget, set by client
 * @member {String} id
 */
Widgetv3.prototype['id'] = undefined;

/**
 * The name of the widget
 * @member {String} name
 */
Widgetv3.prototype['name'] = undefined;

/**
 * Widget options
 * @member {Object.<String, Object>} options
 */
Widgetv3.prototype['options'] = undefined;

/**
 * The ID of the page the widget belongs to, \"0\" if it's in the main page
 * @member {String} page_id
 */
Widgetv3.prototype['page_id'] = undefined;

/**
 * The type of the widget
 * @member {String} type
 */
Widgetv3.prototype['type'] = undefined;

/**
 * @member {Array.<String>} variables
 */
Widgetv3.prototype['variables'] = undefined;

/**
 * Widget current width for desktop
 * @member {Number} width
 */
Widgetv3.prototype['width'] = undefined;

/**
 * Widget current width for mobile
 * @member {Number} width_mobile
 */
Widgetv3.prototype['width_mobile'] = undefined;

/**
 * Widget x position for desktop
 * @member {Number} x
 */
Widgetv3.prototype['x'] = undefined;

/**
 * Widget x position for mobile
 * @member {Number} x_mobile
 */
Widgetv3.prototype['x_mobile'] = undefined;

/**
 * Widget y position for desktop
 * @member {Number} y
 */
Widgetv3.prototype['y'] = undefined;

/**
 * Widget y position for mobile
 * @member {Number} y_mobile
 */
Widgetv3.prototype['y_mobile'] = undefined;
