...
/**
 * The ArduinoWidgetv3template model module.
 * @module model/ArduinoWidgetv3template
 * @version 3.1.2
 */
class ArduinoWidgetv3template {
    /**
     * Constructs a new <code>ArduinoWidgetv3template</code>.
     * ArduinoWidgetv3template media type (default view)
     * @alias module:model/ArduinoWidgetv3template
     ...
     */
    constructor(height, options, pageId, type, width, x, y) { 
        
        ArduinoWidgetv3template.initialize(this, height, options, pageId, type, width, x, y);
    }
     ...
     */
    static initialize(obj, height, options, pageId, type, width, x, y) { 
        obj['height'] = height;
        obj['options'] = options;
        obj['page_id'] = pageId;
        obj['type'] = type;
    ...
    /**
     * Constructs a <code>ArduinoWidgetv3template</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ArduinoWidgetv3template} obj Optional instance to populate.
     * @return {module:model/ArduinoWidgetv3template} The populated <code>ArduinoWidgetv3template</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ArduinoWidgetv3template();
    ...
    /**
     * Validates the JSON data with respect to <code>ArduinoWidgetv3template</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ArduinoWidgetv3template</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ArduinoWidgetv3template.RequiredProperties) {
...
ArduinoWidgetv3template.RequiredProperties = ["height", "options", "page_id", "type", "width", "x", "y"];

/**
 * Widget current height for desktop
 * @member {Number} height
 */
ArduinoWidgetv3template.prototype['height'] = undefined;

/**
 * Widget current height for mobile
 * @member {Number} height_mobile
 */
ArduinoWidgetv3template.prototype['height_mobile'] = undefined;

/**
 * The name of the widget
 * @member {String} name
 */
ArduinoWidgetv3template.prototype['name'] = undefined;

/**
 * Widget options
 * @member {Object.<String, Object>} options
 */
ArduinoWidgetv3template.prototype['options'] = undefined;

/**
 * The ID of the page the widget belongs to, \"0\" if it's in the main page
 * @member {String} page_id
 */
ArduinoWidgetv3template.prototype['page_id'] = undefined;

/**
 * The type of the widget
 * @member {String} type
 */
ArduinoWidgetv3template.prototype['type'] = undefined;
 ...
 */
ArduinoWidgetv3template.prototype['variables'] = undefined;

/**
 * Widget current width for desktop
 * @member {Number} width
 */
ArduinoWidgetv3template.prototype['width'] = undefined;

/**
 * Widget current width for mobile
 * @member {Number} width_mobile
 */
ArduinoWidgetv3template.prototype['width_mobile'] = undefined;

/**
 * Widget x position for desktop
 * @member {Number} x
 */
ArduinoWidgetv3template.prototype['x'] = undefined;

/**
 * Widget x position for mobile
 * @member {Number} x_mobile
 */
ArduinoWidgetv3template.prototype['x_mobile'] = undefined;

/**
 * Widget y position for desktop
 * @member {Number} y
 */
ArduinoWidgetv3template.prototype['y'] = undefined;

/**
 * Widget y position for mobile
 * @member {Number} y_mobile
 */
ArduinoWidgetv3template.prototype['y_mobile'] = undefined;
...
export default ArduinoWidgetv3template;
