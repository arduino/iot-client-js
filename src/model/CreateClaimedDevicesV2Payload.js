...
class CreateClaimedDevicesV2Payload {
    /**
     * Constructs a new <code>CreateClaimedDevicesV2Payload</code>.
    ...
    /**
     * Constructs a <code>CreateClaimedDevicesV2Payload</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateClaimedDevicesV2Payload} obj Optional instance to populate.
     * @return {module:model/CreateClaimedDevicesV2Payload} The populated <code>CreateClaimedDevicesV2Payload</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>CreateClaimedDevicesV2Payload</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateClaimedDevicesV2Payload</code>.
     */
 ...
 */
CreateClaimedDevicesV2Payload.prototype['locked'] = undefined;
