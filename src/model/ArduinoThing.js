...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.IotApi.ArduinoThing = factory(root.IotApi.ApiClient, root.IotApi.ArduinoProperty);
  }
   ...
   */
  var exports = function(href, id, name, userId) {
    var _this = this;
   ...
   */
  exports.prototype['properties_count'] = undefined;
  /**
   * The id of the attached sketch
   * @member {String} sketch_id
   */
  exports.prototype['sketch_id'] = undefined;
  /**
