...
var apiInstance = new IotApi.ThingsV2Api();
var createThingsV2Payload = new IotApi.CreateThingsV2Payload(); // CreateThingsV2Payload | ThingPayload describes a thing
var opts = {
  'force': false // Boolean | If true, detach device from the other thing, and attach to this thing
};
apiInstance.thingsV2Create(createThingsV2Payload, opts).then(function(data) {
...
var thingSketch = new IotApi.ThingSketch(); // ThingSketch | ThingSketchPayload describes a sketch of a thing
apiInstance.thingsV2CreateSketch(id, thingSketch).then(function(data) {
  console.log('API called successfully. Returned data: ' + data);
}, function(error) {
  console.error(error);
});
...
apiInstance.thingsV2Delete(id, opts).then(function() {
...
var apiInstance = new IotApi.ThingsV2Api();
var id = "id_example"; // String | The id of the thing
apiInstance.thingsV2DeleteSketch(id).then(function(data) {
  console.log('API called successfully. Returned data: ' + data);
}, function(error) {
  console.error(error);
});
...
apiInstance.thingsV2List(opts).then(function(data) {
  console.log('API called successfully. Returned data: ' + data);
}, function(error) {
  console.error(error);
});
...
apiInstance.thingsV2Show(id, opts).then(function(data) {
  console.log('API called successfully. Returned data: ' + data);
}, function(error) {
  console.error(error);
});
...
var apiInstance = new IotApi.ThingsV2Api();
var id = "id_example"; // String | The id of the thing
var thing = new IotApi.Thing(); // Thing | ThingPayload describes a thing
var opts = {
  'force': false // Boolean | If true, detach device from the other thing, and attach to this thing
};
apiInstance.thingsV2Update(id, thing, opts).then(function(data) {
  console.log('API called successfully. Returned data: ' + data);
}, function(error) {
  console.error(error);
});
...
apiInstance.thingsV2UpdateSketch(id, sketchId).then(function(data) {
  console.log('API called successfully. Returned data: ' + data);
}, function(error) {
  console.error(error);
});
