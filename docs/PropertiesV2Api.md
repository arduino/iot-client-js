...
var apiInstance = new IotApi.PropertiesV2Api();
var id = "id_example"; // String | The id of the thing
var property = new IotApi.Property(); // Property | PropertyPayload describes a property of a thing. No field is mandatory
apiInstance.propertiesV2Create(id, property).then(function(data) {
...
apiInstance.propertiesV2Delete(id, pid, opts).then(function() {
...
apiInstance.propertiesV2List(id, opts).then(function(data) {
  console.log('API called successfully. Returned data: ' + data);
}, function(error) {
  console.error(error);
});
...
var id = "id_example"; // String | The id of the thing
var pid = "pid_example"; // String | The id of the property
var propertyValue = new IotApi.PropertyValue(); // PropertyValue | PropertyValuePayload describes a property value
apiInstance.propertiesV2Publish(id, pid, propertyValue).then(function() {
  console.log('API called successfully.');
}, function(error) {
  console.error(error);
});
...
apiInstance.propertiesV2Show(id, pid, opts).then(function(data) {
  console.log('API called successfully. Returned data: ' + data);
}, function(error) {
  console.error(error);
});
...
var pid = "pid_example"; // String | The id of the property
var property = new IotApi.Property(); // Property | PropertyPayload describes a property of a thing. No field is mandatory
apiInstance.propertiesV2Update(id, pid, property).then(function(data) {
  console.log('API called successfully. Returned data: ' + data);
}, function(error) {
  console.error(error);
});
